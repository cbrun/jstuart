...
public class Date {
     ...
     * @param dateType
     */
    public Date(String value, String timezone, String timezoneDb, String dateType) {
        this.value = value;
    ...
    public Date withTimezone(String timezone) {
        this.timezone = timezone;
        return this;
    }
    ...
    public Date withTimezoneDb(String timezoneDb) {
        this.timezoneDb = timezoneDb;
        return this;
    }
    ...
    public Date withDateType(String dateType) {
        this.dateType = dateType;
        return this;
    }
